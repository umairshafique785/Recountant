    ...
    public class AccountController : Controller
    {
        ...
        public long RegisterUser(UserInfo userinfo)
        {
            var Newuser = new MyUser
            {
                ...
                CNIC_Number = userinfo.CNIC_Number,
                EPZ = userinfo.EPZ,
                Email = userinfo.Email,
                Filer_NonFiler = userinfo.Filer_NonFiler,
                Gender = userinfo.Gender,
                Individual_AOP_Company = userinfo.Individual_AOP_Company,
                Industry = userinfo.Industry,
                Name = userinfo.Name,
                NTN = userinfo.NTN,
                STRN = userinfo.STRN,
                PhoneNumber = userinfo.Contact_Number,
                Residential_Status = userinfo.Residential_Status
            };
